document.getElementById("promeniStranicu2").onclick = ev => promeniStranicu2();
document.getElementById("promeniStranicuUnazad2").onclick = ev => promeniStranicuUnazad2();

function promeniStranicu2(){
    console.log("nesto drugo");
    var pom=document.getElementById("brojStranice2");
    pom.innerHTML++;
